...
namespace Ecommerce.Auth.Data.Migrations
{
    ...
    [Migration("20260812165445_DropEmailConfirmed")]
    partial class DropEmailConfirmed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Auth.Domain.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ecommerce.Auth.Domain.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Ecommerce.Auth.Domain.UserRole", b =>
                {
            ...
            modelBuilder.Entity("Ecommerce.Auth.Domain.UserRole", b =>
                {
                    b.HasOne("Ecommerce.Auth.Domain.Role", "Role")
                        .WithMany("UserRoles")
                    ...
                    b.HasOne("Ecommerce.Auth.Domain.AppUser", "User")
                        .WithMany("UserRoles")
